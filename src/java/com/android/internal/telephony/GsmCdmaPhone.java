    ...
    public void handleMessage(Message msg) {
        ...
        switch (msg.what) {
            ...
            case EVENT_GET_BASEBAND_VERSION_DONE:
                ...
                /* Android property value is limited to 91 characters, but lower layers could pass
                 * a longer version string.
                 * To avoid runtime exceptions, truncate the baseband version string to at most 45
                 * characters. This is because the baseband version of both the subscriptions are
                 * combined and stored in a single property. Also, since the latter part of this
                 * string is more meaningful, truncate it from the beginning and keep the end.
                */
